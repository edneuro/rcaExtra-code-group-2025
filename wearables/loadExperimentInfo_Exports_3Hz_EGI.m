function adults6HzInfo = loadExperimentInfo_Exports_3Hz_EGI
    ...
    adults6HzInfo.info.groupLabels = {'3Hz EGI'};%change name for Wearables
    ...
    %adults6HzInfo.info.frequencyLabels = {'1F1', '2F1', '4F1', '5F1', '7F1', '8F1'};%TO CHANGE
