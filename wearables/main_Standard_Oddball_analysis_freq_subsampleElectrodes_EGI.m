function main_Standard_Oddball_analysis_freq_subsampleElectrodes_EGI
%change name
...
if subsampElectrodes
    ...
    sensorData = subsampleElectrodes(sensorData,'dsivr300');
    cellNoiseData1 = subsampleElectrodes(cellNoiseData1,'dsivr300');
    cellNoiseData2 = subsampleElectrodes(cellNoiseData2,'dsivr300');
...
save data_for_RCA_24 rcSettings_byCondition sensorData  cellNoiseData1 cellNoiseData2
