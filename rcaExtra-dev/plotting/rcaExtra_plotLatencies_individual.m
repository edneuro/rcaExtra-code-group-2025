function fh_PhasesFreqs = rcaExtra_plotLatencies_individual(rcaResult, plotSettings)
    ...
    for cp = 1:numel(plotSettings.RCsToPlot)
        ...
        try
            saveas(fh_PhasesFreqs{cp}, ...
                fullfile(rcaResult.rcaSettings.destDataDir_FIG,'condition2_WvsOLN', [fh_PhasesFreqs{cp}.Name '.fig']));
            close (fh_PhasesFreqs{cp}, ...
                fullfile(rcaResult.rcaSettings.destDataDir_FIG,'condition2_WvsOLN', [fh_PhasesFreqs{cp}.Name '.fig']));
        catch err
