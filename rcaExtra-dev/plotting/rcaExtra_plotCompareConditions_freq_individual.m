function rcaExtra_plotCompareConditions_freq_individual(plotSettings, rcaResult)
...
% rcaResult.rcaSettings.
    ...
    fh_Lolli = rcaExtra_plotLollipops_individual(rcaResult, plotSettings_loli);
    % Latency plots, copy global plot settings and modify if needed;
    
    plotSettings_lat = plotSettings;
    fh_Lat = rcaExtra_plotLatencies_individual(rcaResult, plotSettings_lat);
    
    % aplitude plots, copy global plot settings and modify if needed;
    plotSettings_amp = plotSettings;
    fh_Amp = rcaExtra_plotAmplitudes_individual(rcaResult, plotSettings_amp);
