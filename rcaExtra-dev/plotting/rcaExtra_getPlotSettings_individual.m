function plotSettings = rcaExtra_getPlotSettings_individual(rcaResult)
...
plotSettings.domain = rcaResult.rcaSettings.domain;
    ...
    plotSettings.resultsDir = fullfile(rcaResult.rcaSettings.destDataDir_FIG,'condition3_OLNvsOIN');
