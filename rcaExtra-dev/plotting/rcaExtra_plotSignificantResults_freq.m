function rcaExtra_plotSignificantResults_freq(rcaResult1, rcaResult2, statData, plotSettings)
    ...
    for nc = 1:nConditions
        ...
        legendLabels = cellfun(@(x, y) strcat(x, '_', y), ...
            plotSettings.groupLegends, repmat(plotSettings.legendLabels(nc), [1 nGroups]), 'uni', false);
...
%                     useColors, legendLabels, pValues);
                ...
                saveas(ampPlot_rc_Cnd, ...
                 ...
                 % change figure size and save to .fig and .jpg
                set(gcf,'Position',[0.2 0.4 0.4 0.4])
                saveas(ampPlot_rc_Cnd, ...
                    fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [ampPlot_rc_Cnd.Name '_amplitude.fig']));
                saveas(ampPlot_rc_Cnd, ...
                    fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [ampPlot_rc_Cnd.Name '_amplitude.jpg']));
             ...
             % if don't want to save uniform ylim figures, comment this part out   
%                 set(gcf,'Position',[0.2 0.4 0.4 0.4])
%                 saveas(ampPlot_rc_Cnd, ...
%                     fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [ampPlot_rc_Cnd.Name '_amplitude.fig']));
%                 saveas(ampPlot_rc_Cnd, ...
%                     fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [ampPlot_rc_Cnd.Name '_amplitude.jpg']));
            ...
            try
%                  latPlot_rc_Cnd = rcaExtra_latplot_freq_stats_fang(freqVals, lats, latErrs, ...
%                      useColors, legendLabels, sigIdx);
                ...
                saveas(latPlot_rc_Cnd, ...
                 ...
                 % change figure size and save to .fig and .jpg
                set(gcf,'Position',[0.17 0.45 0.4 0.4])
                saveas(latPlot_rc_Cnd, ...
                    fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [latPlot_rc_Cnd.Name '_latency.fig']));
                                saveas(latPlot_rc_Cnd, ...
                    fullfile(rcaResult1.rcaSettings.destDataDir_FIG, [latPlot_rc_Cnd.Name '_latency.jpg']));
