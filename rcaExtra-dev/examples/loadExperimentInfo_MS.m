function adults6HzInfo = loadExperimentInfo_MS
    ...
    adults6HzInfo.info.subDirMat = 'EExp_MATL_HCN_128_Avg';
    adults6HzInfo.info.groupLabels = {'MS'};
    adults6HzInfo.info.conditionLabels = {'WvsPF', 'NWvsPF', 'WvsNW', 'Vernier'};
