...
scalpFile = ['/Volumes/MRI/anatomy/FREESURFER_SUBS/' subjId '_fs4/bem/' subjId '_fs4-head.fif'];
...
elpFile = ['/Volumes/MRI/data/4D2/JMA_PROJECTS/c1v1flip/mrcProj/' subjId '/Polhemus/MQM_chpstxDual2Cond_20090414.elp'];
regFile = ['/Volumes/MRI/data/4D2/JMA_PROJECTS/c1v1flip/mrcProj/' subjId '/_MNE_/elp2mri.tran'];
eegFile = ['/Volumes/MRI/data/4D2/JMA_PROJECTS/c1v1flip/mrcProj/' subjId '/Exp_MATL_HCN_128_Avg/Axx_c903.mat'];
eegIndex = 45;
...
rgbCdata = cmap(cdata,:);
set(hs,'facevertexcdata',rgbCdata,'cdatamapping','direct')
