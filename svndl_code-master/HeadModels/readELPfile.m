function [Epos,Ename,Etype,Fpos,kSort] = readELPfile(fileName,sortByName,xfmFid,swapDim)
% reads elp-format electrode position files
% [Epos,Ename,Etype,Fpos] = readELPfile(fileName,sortByName,xfmFid,swapDim)
...
if exist('swapDim','var')
	...
	error('Invalid swapDim input to readELPfile.  Valid inputs satisfy: sort(abs(swapDim)) = [1 2 3]')
end
