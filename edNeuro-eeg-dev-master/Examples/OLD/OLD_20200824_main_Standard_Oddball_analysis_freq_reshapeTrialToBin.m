function main_Standard_Oddball_analysis_freq_reshapeTrialToBin
...
if reshapeTrialToBin
    ...
    sensorData = cellfun(@(x) reshapeTrialToBinForRCA(x, length(rcSettings.binsToUse)),...
        sensorData_tr, 'UniformOutput', false);
    
    % Adjust rcSettings accordingly
    rcSettings_tr = rcSettings; % Move orig to new variable
    rcSettings.binsToUse = 1; % Used to be 1:10
