function adults6HzInfo = loadExperimentInfo_DSS_EEG_2023_2
    ...
    %'BLC_*'
    adults6HzInfo.info.subjTag = 'BLC_*';
    ...
    adults6HzInfo.info.conditionLabels = {'Cond1', 'Cond2', 'Cond3', 'Conditions123'};
    adults6HzInfo.info.frequenciesHz = [1, 3];
    adults6HzInfo.info.useSpecialDataLoader = false;
    adults6HzInfo.info.frequencyLabels = {{'1F1', '2F1', '4F1','5F1','7F1','8F1'},{'1F2', '2F2', '3F2', '4F2','5F2','6F2','7F2','8F2','9F2'}};
