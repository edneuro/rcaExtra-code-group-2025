function adults6HzInfo = loadExperimentInfo_2019_K2_Data_indiv(sourcepath,destpath)
...
%     adults6HzInfo.path.destDataDir = uigetdir(curr_path, 'Select analysis results directory');
    ...
    adults6HzInfo.info.conditionLabels = {'WvsPF', 'WvsOLN', 'OLNvsOIN'};
    adults6HzInfo.info.frequenciesHz = [1, 2];
